...
def run_cuj(page):
    ...
    # Mock login as admin 'Neocryptz' and hide auth screen
    page.evaluate("""() => {
        const user = {
            username: 'Neocryptz',
            is_admin: true,
    ...
    page.wait_for_timeout(1000)
    page.screenshot(path="/home/jules/verification/screenshots/admin_modal_v4.png")

    # Click SUPPORT tab
    page.get_by_role("button", name="SUPPORT").click()
    page.wait_for_timeout(1000)
    page.screenshot(path="/home/jules/verification/screenshots/admin_support_v4.png")
